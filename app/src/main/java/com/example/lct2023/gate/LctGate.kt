...
import com.example.lct2023.gate.model.ReserveMeetRequest
...
class LctGate : Gate() {
    ...
    fun reserveMeet(slotId: String, topicId: String){
        val response = makePostRequest("meetings/reserve", ReserveMeetRequest(slotId, topicId))
    }
    ...
    fun getApprovedList(): List<OpenSlotResponse>{
